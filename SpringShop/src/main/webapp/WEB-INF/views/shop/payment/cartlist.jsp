...
<body>
	...
	<script type="text/javascript">
	 var clientKey = 'test_ck_k6bJXmgo28e2lgAbBvW3LAnGKWx4'
    ...
    function showPayform(){
		 tossPayments.requestPayment('카드', { // 결제 수단 파라미터
			  // 결제 정보 파라미터
			  amount: 1000,
			  orderId: 'gM79xyOz8gtQMuHc9ekQG',  //주문번호 - 문자열로 임의로 만들기 (주문을 구분하기 위함)
			  orderName: '토스 티셔츠 외 2건',  //문자열 처리
			  customerName: '박토스',  //로그인한 고객의 이름
			  //결제 성공이 아닌, 결제요청 성공 시 넘겨받을 콜백 (cf : 결제승인)

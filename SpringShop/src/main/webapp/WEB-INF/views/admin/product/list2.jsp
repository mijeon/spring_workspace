	...
	<script type="text/javascript">
		...
		app1=new Vue({
			...
			data:{
				...
				num:0  //페이지당 시작번호를 뷰컴포넌트에서 접근할 수 있도록
			}
		});
		...
		function pageLink(n){
			...
			//넘겨받은 페이지 번호를 이용해 해당 페이지에 보여질 배열 생성 후 currentList에 대입
			//Vue의 변수인 currentList만 제어하면 디자인은 자동으로 변경됨
			app1.currentList.splice(0, app1.currentList.length);  //싹비우고 
